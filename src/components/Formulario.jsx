...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if(paciente.id) {
      ...
      //Nuevo registro
      //Paso una copia de la lista de pacientes mas el nuevo paciente porque el estado de la app no lo puedo modificar acá, debo hacer uso del modificador setPacientes
